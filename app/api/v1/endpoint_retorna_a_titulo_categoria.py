...
from app.api.v1.endpoint_categoria import dados_csv  # seu DataFrame com colunas 'title' e 'category'
...
async def search_books(
    title_param: str | None = Query(default=None, alias="title", description="Título ou parte do título do livro"),
    category_param: str | None = Query(default=None, alias="category", description="Categoria do livro")
):
    ...
    if df_filtrado.empty:
        if title_param and category_param:
            ...
            raise HTTPException(status_code=404, detail="Nenhum livro encontrado para a categoria informada.")
